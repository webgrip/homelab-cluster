...
> Status: **Proposed** · Date: 2026-06-13 · Part of [RFC: Cutting the GitOps umbilical](rfc-flux-forgejo-source.md)
...
Full sequence and the gap-free cutover-commit mechanic are in the [RFC](rfc-flux-forgejo-source.md).
