...
> Status: **Accepted** · Date: 2026-06-12 · Part of [RFC: Security Hardening](rfc-security-hardening.md)

## Context

With the [SOPS → ESO/OpenBao migration](../../blog/2026-06-12-the-long-goodbye-to-sops.md) done,
...
3. **Reloader** sees the Secret change and restarts the consuming workload — *provided that workload
   ...
   consumers is therefore a required step, tracked in [Adding Applications](../adding-applications.md).
