...
([ADR-0011](adr-0011-dual-run-renovate-forgejo.md)): flipping `webgrip-gitops` to Forgejo today would
...
- **GHCR → Harbor** — the `read:packages` PAT ([ADR-0013](adr-0013-github-as-renovate-data-oracle.md))
...
| # | Decision | Choice |
|---|----------|--------|
| [ADR-0011](adr-0011-dual-run-renovate-forgejo.md) | Rollout shape | **Dual-run** — a second RenovateJob `webgrip-forgejo` beside `webgrip-gitops`; retire GitHub at final cutover. Not an in-place flip. |
| [ADR-0012](adr-0012-forgejo-static-bot-pat.md) | Forgejo authentication | **Static bot PAT** via ESO/OpenBao; **delete the GitHub-App token-minter CronJob** on the Forgejo path. |
| [ADR-0013](adr-0013-github-as-renovate-data-oracle.md) | GitHub during transition | Keep GitHub as a **read-only data oracle** — datasources, `github>` presets, and GHCR via a `read:packages` PAT. |
...
once in OpenBao and projected verbatim ([ADR-0012](adr-0012-forgejo-static-bot-pat.md)).
...
Forgejo/OpenBao bootstrap) is in [Renovate → Forgejo migration](../renovate-forgejo-migration.md);
...
section in [Renovate](../renovate.md) is corrected to the ESO model. Disaster recovery is unchanged —
Renovate holds no state; re-running a job is idempotent.

## References

- ADRs [0011](adr-0011-dual-run-renovate-forgejo.md), [0012](adr-0012-forgejo-static-bot-pat.md),
  [0013](adr-0013-github-as-renovate-data-oracle.md)
- [Renovate → Forgejo migration](../renovate-forgejo-migration.md) · [Renovate](../renovate.md) ·
  [Forgejo](../forgejo.md) · [RFC: Harbor](rfc-harbor-registry.md)
- [Bringing the Forge Home](../blog/2026-06-12-bringing-the-forge-home.md) ·
