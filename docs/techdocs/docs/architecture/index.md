...
| [Renovate on Forgejo](rfc-renovate-forgejo.md) | Accepted | Migrate Renovate off GitHub onto Forgejo via a second dual-run RenovateJob; cut repos over as each becomes authoritative. |
