...
- `kubernetes/apps/arc-systems/gha-runner-scale-set/` provisions the normal runner pool on the SOYO nodes.
- `kubernetes/apps/arc-systems/gha-runner-scale-set-heavy/` provisions the heavy Docker-in-Docker runner pool on fringe-workstation.
