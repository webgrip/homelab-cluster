...
[ADR-0006](adr-0006-default-deny-network-policies.md), the canonical default-deny ADR.) The same
...
* 2026-06-30 — n8n's OIDC config removed (`d15b8e22` — it was a non-functional, Enterprise-gated
  ...
  component
* 2026-07-02 — superseded in scope by [ADR-0006](adr-0006-default-deny-network-policies.md), which
