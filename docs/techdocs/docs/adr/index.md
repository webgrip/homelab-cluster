...
| [ADR-0039](adr-0039-default-deny-network-policies.md) | Proposed | Opt-in per-namespace default-deny NetworkPolicies (Kyverno-generated) + reusable `cnpg-netpol` / `gateway-egress` components; identity-based egress, not CIDR/port. |
