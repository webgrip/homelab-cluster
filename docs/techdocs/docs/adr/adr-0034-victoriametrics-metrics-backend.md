...
* **Its default rules/dashboards are not GitOps.** `defaultRules` (and default dashboards when
  ...
  [ADR-0006](adr-0006-default-deny-network-policies.md) default-deny it's another
...
* 2026-07-03 — renumbered from ADR-0038 (pre-re-baseline numbering) in the layered re-ordering of the ADR set (see [index](index.md))
