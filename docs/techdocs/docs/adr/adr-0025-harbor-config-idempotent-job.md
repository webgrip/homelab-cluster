...
([ADR-0023](adr-0023-harbor-pull-through-proxy-cache.md)) are **Harbor-internal objects**, created
...
codified in [ADR-0003](adr-0003-bootstrap-task-pattern.md) — idempotent `GET`-before-create
