...
interim host, Codeberg Pages ([ADR-0038](adr-0038-codeberg-pages-techdocs.md)), serves a bare
...
**`awsS3` publisher on Garage S3** ([ADR-0018](adr-0018-registry-blob-storage-garage-s3.md) already
...
**Codeberg Pages is retained as the off-site DR mirror** (ADR-0038): the docs workflow keeps a
