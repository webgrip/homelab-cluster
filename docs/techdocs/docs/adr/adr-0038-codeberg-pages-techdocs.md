...
[ADR-0039](adr-0039-backstage-techdocs.md) — is built out later. The
...
already chosen in [ADR-0014](adr-0014-codeberg-offsite-push-mirror.md).
...
This is **explicitly interim and off-site** — the documentation half of the ADR-0014 redundancy
story. When Backstage TechDocs (ADR-0039) lands as the primary in-cluster surface, Codeberg Pages
...
* Bad, because public-only; access-controlled docs wait for Backstage + Authentik
  ([ADR-0039](adr-0039-backstage-techdocs.md)).
...
* Good, because it is the sequenced long-term primary ([ADR-0039](adr-0039-backstage-techdocs.md)).
