...
* 2026-07-02 — unaffected by the [ADR-0034](adr-0034-victoriametrics-metrics-backend.md)
...
* 2026-07-03 — renumbered from ADR-0030 (pre-re-baseline numbering) in the layered re-ordering of the ADR set (see [index](index.md))
