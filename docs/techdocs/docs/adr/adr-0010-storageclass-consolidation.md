...
([ADR-0008](adr-0008-confine-longhorn-to-workers.md)), **2 is the ceiling anyway**. The remaining
...
| `longhorn-cold` | 1 | HDD (`cold`) | bulk / low-IOPS — [ADR-0009](adr-0009-longhorn-hot-cold-tiers.md) |
...
* 2026-06-21 — `longhorn-gitops` (the planned 3-replica forgejo/openbao exception) retired unbuilt
  with the [ADR-0008](adr-0008-confine-longhorn-to-workers.md) update; dropped from the target set
...
* 2026-07-03 — renumbered from ADR-0029 (pre-re-baseline numbering) in the layered re-ordering of the ADR set (see [index](index.md))
