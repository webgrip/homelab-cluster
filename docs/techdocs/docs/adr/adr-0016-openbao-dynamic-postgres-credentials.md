...
rotate ([ADR-0015](adr-0015-secret-rotation-model.md)), but rotation is a manual, reactive act and
...
* Keep static creds + faster rotation (ADR-0015 with a short `refreshInterval`)
...
[ADR-0015](adr-0015-secret-rotation-model.md).
