...
- **No scanning gate at rest.** Vulnerability posture is computed downstream
  (dependency-track / guac, see [Supply Chain Pipeline](../general/supply-chain-pipeline.md)) but nothing
...
[Adding Applications](../general/adding-applications.md) and [CNPG Backups](../runbooks/cnpg-backups.md).
