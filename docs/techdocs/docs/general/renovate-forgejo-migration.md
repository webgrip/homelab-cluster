...
> [ADR-0011 (dual-run)](../adr/adr-0011-dual-run-renovate-forgejo.md) ·
> [ADR-0012 (static bot PAT)](../adr/adr-0012-forgejo-static-bot-pat.md) ·
> [ADR-0013 (GitHub as data oracle)](../adr/adr-0013-github-as-renovate-data-oracle.md).
> How Renovate runs today is in [Renovate](renovate.md). Part of the
> [forge migration](../blogs/2026-06-12-bringing-the-forge-home.md).
...
[ADR-0011](../adr/adr-0011-dual-run-renovate-forgejo.md).
...
### Phase 0 — Forgejo bot + token (zero-touch, GitOps — Tier-1 do-once Job per [ADR-0019](../adr/adr-0019-bootstrap-task-pattern.md))
...
GitHub path ([ADR-0013](../adr/adr-0013-github-as-renovate-data-oracle.md)) — wired as an
...
- GHCR → Harbor — the `read:packages` PAT is the stopgap; re-homes under
  [RFC: Harbor](../rfc/rfc-harbor-registry.md).
