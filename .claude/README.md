...
| --- | --- | --- |
| `grafana` | `kubernetes/apps/observability/mcp-grafana/` | `https://mcp-grafana.${SECRET_DOMAIN}/mcp` — VictoriaMetrics (PromQL) / Loki / Tempo (Pyroscope suspended pending ADR-0032) |
